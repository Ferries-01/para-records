...
python3 main.py --url https://www.ipc-services.org/sdms/web/record/at/excel/type/ECR/category/out/age/senior --output records/europeanchampionship.csv --code ECR
